...
<section class="breadcrumb-section section" data-scroll-index="0" data-bg-image-path="img/bg/baner-med.png">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="services-detail-img">
                                <img src="img/bg/cataracta.png" alt="Services Detail img" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
...
<li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="services-detail-img">
                                <img src="img/bg/operatie.png" alt="Services Detail img" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
