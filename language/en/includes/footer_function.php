...
<footer id="footer">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="footer-social-link">
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/centrulmedicalpromed/#">
                                                <i class="fab fa-facebook-f"></i>
                                            </a>
                                        </li>                                      
                                        <li>
                                            <a href="https://www.instagram.com/promed.centrul.medical/?hl=ru">
                                                <i class="fab fa-instagram"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.youtube.com/channel/UCKp2lTH_DU2Mt6v8nnzK44w">
                ...
                <!--// #copyright //-->
                                        ...
                                        <a href="index-particles.html#" class="scroll-top-btn" data-scroll-goto="0"><i class="fa fa-chevron-up"></i></a>
        <!--// .scroll-top-btn //-->
        ...
        <!--// Scripts //-->
        <script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="vendor/js/jquery.min.js"></script>
